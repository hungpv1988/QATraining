...
namespace StudentAppMvc.Controllers
{
    ...
    public class ThtrStudentController : Controller
    {
        ...
        //public ActionResult Search(StudentListViewModel studentListVewModel)
        //{
        //    StudentListViewModel studentListDTO = new StudentListViewModel(_studentService.Search(studentListVewModel.SearchingCriteriaLst));
        //    ViewBag.SearchingCriteria = studentListVewModel.SearchingCriteriaLst;
        //    return View(studentListDTO);
        //}
